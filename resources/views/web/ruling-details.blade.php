    ...
    <section id="stats-counter" class="stats-counter section-bg">
        <div class="container">
            ...
            @if ($ruling->isExpirated())
                <div class="alert alert-warning d-flex align-items-center col" role="alert">
                    <div>
                        <h3>Atenção.</h3>
                        Não é possível assinar essa pauta, devido à mesma estar expirada para assinatura.
                    </div>
                </div>
            @endif
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="stats-item d-flex align-items-center w-100 h-100">
                        ...
                        <div>
                            @php
                                $company_signs = $ruling->rulingVoting->where('cnpj',"!=", null)->count();
                            @endphp
                            <span data-purecounter-start="{{ ($company_signs / 100) * 50 }}" data-purecounter-end="{{ $company_signs }}" data-purecounter-duration="3"
                                class="purecounter"></span>
            ...
            <div class="modal-xl modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3>Para prosseguir sua assinatura, preencha os campos abaixo.</h3>
